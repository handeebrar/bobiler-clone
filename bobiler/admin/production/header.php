...
//Yetkisiz Sayfaya erişim engellemek için
if($say==0) {
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a href="etiket.php"><i class="fa fa-list"></i> Etiketler </a></li>
                <li><a href="monte.php"><i class="fa fa-image"></i> Monteler </a></li>
              </ul>
            </div>
          </div>
          <!-- /sidebar menu -->
