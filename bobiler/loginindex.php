...
$montesorma=$db->prepare("SELECT * FROM monte");
$montesorma->execute();
$montecekme=$montesorma->fetch(PDO::FETCH_ASSOC);
									...
									<ul class="bobi-comment-list bobi-show-small">
										...
										<form action="admin/netting/islem.php" method="POST">
											<li class="bobiler-feed-comment-box uk-form">
												...
												<input class="uk-width-1-1" type="text" name="yorum_icerik" placeholder="yorum ekleyin..." />
												...
												while($yorumcek=$yorumsor->fetch(PDO::FETCH_ASSOC)) { 
													...
													<form action="admin/netting/islem.php" method="POST">
														...
														<input class="uk-width-1-1" type="text" name="yoruma_yorum_icerik" placeholder="yorumu cevaplayın...">
